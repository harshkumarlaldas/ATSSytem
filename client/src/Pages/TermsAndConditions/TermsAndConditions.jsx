    ...
    <div className="min-h-screen p-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded shadow">
       ...
       <div className='overflow-auto  h-2/3'> 
        ...
        <p className="mb-4">
          By accessing or using the RapidHire website, you agree to comply with and be bound by these Terms and Conditions.
        </p>

        <h2 className="text-xl font-semibold mb-2">2. Intellectual Property</h2>
        <p className="mb-4">
          All content on this website, including text, images, graphics, logos, and software, is the property of RapidHire and protected by intellectual property laws.
        </p>
        ...
        <p className="mb-4">
          RapidHire shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues.
        </p>
