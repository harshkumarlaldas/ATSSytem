    ...
    <div>
      <div className="relative inline-block">
        <button
          ...
          className="bg-orange-700 text-white px-2 py-1 rounded-md cursor-pointer relative"
        >
...
//     try {
//       const response = await fetch(
//         RAPIDHIRE_ENDPOINT + `updated-two/${id}?action=${itemName}`,
//         {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
...
//       const promises = [
//         fetch(RAPIDHIRE_ENDPOINT + `updated-one/${id}?action=${itemName}`, {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
//           },
//         }),
//         fetch(RAPIDHIRE_ENDPOINT + `updated-two/${id}?action=${itemName}`, {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
//           },
