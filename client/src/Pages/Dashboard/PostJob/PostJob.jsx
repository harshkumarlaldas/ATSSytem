                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`
        w-full px-4 py-2 bg-white border-[1px] border-orange-500 rounded-md shadow-sm
      ...
      `}
                  ...
                  <div>
                    <div className="space-x-4">
                      <button
                        type="submit"
                        className="bg-[#0C1C4D] text-white outline-none px-4 py-1 rounded-md text-[20px] font-medium"
                      >
                        Save Draft
                      </button>
                      <button
                        type="submit"
                        className="border-[1px] text-gray-500 border-[#0C1C4D] outline-none px-4 py-1 rounded-md text-[20px] font-semibold"
                      >
                        Save & continue
                      </button>
                    </div>
