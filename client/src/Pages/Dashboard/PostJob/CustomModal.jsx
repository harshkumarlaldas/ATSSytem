      ...
      <div className="modalContainer p-6 rounded-lg shadow-md scroll-m-1 bg-white">
        ...
        <div>
          ...
          <div className="mb-4 flex justify-between items-center border-b-[1px] shadow-md rounded-md p-4">
            ...
            <button className="text-blue-900 hover:text-[#004f46] flex items-center cursor-pointer">
            ...
            <TabPanel>
              <div className="">
                <div className="overview-content p-4 divide-y-2 leading-7 space-y-5">
                  ...
                  <button className="bg-[#0C1C4D] px-8 py-1 rounded-md font-semibold text-white w-full mt-6">Apply for the post</button>
                </div>
              </div>
            </TabPanel>
            <TabPanel>
