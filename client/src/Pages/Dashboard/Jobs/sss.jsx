      ...
      <div className="">
        ...
        <div className="md:px-8 w-full px-4 bg-white shadow-md py-4 mb-5">
          <div className="flex justify-between">
            ...
            <div>
              <button className="bg-[#0C1C4D] border-2 border-[#0C1C4D] px-5 py-2 rounded-lg text-white font-medium hover:bg-[#005f56] hover:border-[#005f56] transition-colors 3s ease-in-out">
                Create a new job
              </button>
            </div>
          </div>
        ...
        <div className="flex gap-14 border rounded-md border-gray-400 py-4  items-center bg-white justify-between px-10">
          <div className="space-y-3">
            ...
            <button className=" text-blue-900 px-5 py-1 border border-[#0C1C4D] rounded-lg hover:bg-[#ffffdd] transition-colors 3s ease-in-out font-medium">
              Post a job
            </button>
          </div>
        </div>
