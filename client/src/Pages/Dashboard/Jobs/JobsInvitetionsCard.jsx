...
const JobsInvitationsCard = () => {
  ...
  return (
    <div className="pb-20 grid lg:md:grid-cols-3 gap-7">
      {/* First card */}
      <div
      ...
      >
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-500 text-sm">
            Invite your team to RapidHire so you can share feedback and work
      ...
      >
        {/* <div className="space-y-3">
          ...
          <p className="text-gray-500 text-sm">
            RapidHire is best when it's customized for you. Check out all of our
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => handleSendInvite(2)} // Pass the index 1
            disabled={buttonDisabled[1]} // Use the disabled state for this button
            className={`px-4 py-1 mt-4 text-swift font-semibold border border-[#00673B] rounded-md ${
              buttonClicked[1] ? "opacity-30 cursor-not-allowed" : ""
            }`}
          >
            Send invite
