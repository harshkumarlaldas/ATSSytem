    ...
    <div className="pt-56">
      ...
      <div className="pt-6">
        <div className="flex items-center justify-between">
          ...
          <button className="border-orange-500 border px-4 py-1 rounded-md hover:border-orange-800 text-second hover:text-swift">
            View desktop mode
          </button>
        </div>
        ...
        <div className="flex gap-9 w-11/12 mx-auto pt-10">
            ...
            <div>
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-[#daf2da] px-3 py-1 rounded-full text-sm font-medium text-blue-900">
                    Mandatory
                  </button>
                </div>
                {/* Heading */}
          ...
          <div className="text-center mx-auto">
            ...
            <div className="border border-orange-700 rounded-md w-3/4 px-4 py-3 mx-auto">
              ...
              <button className="bg-orange-500 px-5 py-2 rounded-lg  text-white font-medium mt-5">
                Import resume from
              </button>
            </div>
            {/* Require Fileds */}
            <div className="w-3/4 mx-auto py-7 text-start">
              ...
              <div className="space-y-7">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="file"
                    className="w-full rounded-lg border border-orange-500 px-2 py-1"
                    name=""
                    id=""
                  />
                </div>
              ...
              <div className="space-y-7 pt-9">
                ...
                <div className="space-y-2 flex justify-between items-center">
                  ...
                  <button className="border border-orange-700 px-5 py-1 rounded-lg">
                    Add
                  </button>
                </div>
                <div className="space-y-2 flex justify-between items-center">
                ...
                <div className="space-y-2 ">
                  ...
                  <textarea className="w-full h-32 p-3  focus:outline-none border border-orange-700 focus:shadow-outline hover:bg-gray-100 rounded"></textarea>
                </div>
                <div>
                  <p className="text-second">
                  ...
                  <input
                    type="file"
                    className="px-2 py-1 border border-orange-700 w-full rounded-md"
                    name=""
                    id=""
                  />
                </div>
              ...
              <div className="space-y-7 pt-9">
                ...
                <button className="mx-auto w-full font-semibold py-2 rounded-lg hover:bg-orange-500 bg-orange-500">
                  Submit Application
                </button>
              </div>
            </div>
      ...
      <div className="py-10 w-11/12 mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-7">
            <button className="font-semibold text-white bg-orange-500 hover:bg-orange-800 px-5 py-2 rounded-lg">
          ...
          <div className=" flex  items-center">
            <button className="border-orange-500 border px-4 py-1 rounded-l-md hover:border-orange-800 text-second hover:text-swift">
              Archive Job
            </button>
            <div
              onClick={toggleDropdown}
              className="border border-orange-500 rounded-r-md"
            >
              {isDropdownOpen ? (
              ...
              {isDropdownOpen && (
                <div className="absolute right-20 -mt-56 border border-orange-500 bg-white rounded-md shadow-lg">
