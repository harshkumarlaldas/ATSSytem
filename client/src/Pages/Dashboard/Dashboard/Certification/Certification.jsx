...
const Certification = () => {
  ...
  useEffect(() => {
    const URL = RAPIDHIRE_ENDPOINT + `/all-applications/${id}`;
    fetch(URL)
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <button
              ...
              className="bg-[#0C1C4D]-700 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md w-full transition duration-300 transform hover:scale-105"
            >
          ...
          <div className=" bg-white rounded-lg shadow-xl p-4 md:p-8 w-1/2">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-4">
              ...
              <button
                ...
                className="border border-[#0C1C4D]-700 hover:bg-green-700 text-gray-700 hover:text-white font-semibold py-2 px-4 rounded-md w-full  transition duration-300 transform hover:scale-105"
              >
                Download PDF
              </button>
