...
const CandidateSource = () => {
      ...
      const totalCandidate = candidiateSourceData.reduce((total, source) => total + parseInt(source.candidiate), 0);
                        ...
                        <div className="navbar-start">
                              <div className="dropdown">
                                    <label tabIndex={0} className="ml-4 flex justify-center items-center  ">
                                          <h3 className='font-semibold text-2xl'>Candidate Source</h3>
                              ...
                              <div className='hover:bg-slate-300 p-4 rounded-full'>
                                    <div className='p-10 bg-slate-600 rounded-full'>
                                          <div className='bg-white rounded-full px-8 py-12 flex flex-col'>
                                                <div className='text-center font-semibold'>{totalCandidate}</div>
                                                <div className='text-center font-semibold'>Candidate</div>
                                          </div>
                                    </div>
                              </div>
                              <div className='hover:bg-slate-300 p-4 rounded-full'>
