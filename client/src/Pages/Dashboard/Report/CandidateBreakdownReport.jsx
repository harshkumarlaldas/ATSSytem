...
const CandidateBreakdownReport = () => {
                        ...
                        <div className="navbar-start ">
                              <div className="dropdown">
                                    <label tabIndex={0} className="ml-4 flex justify-center items-center  ">
                                          <h3 className='font-semibold text-2xl'> Candidate Breakdown</h3> <FaAngleDoubleDown className='pt-2 text-2xl font-semibold'></FaAngleDoubleDown>
                                    </label>
...
export default CandidateBreakdownReport;