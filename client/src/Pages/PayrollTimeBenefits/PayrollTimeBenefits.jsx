    ...
    <div className="px-12 pt-16 pb-8">
      <div className="text-center pt-16">
        <Title
          ...
          subTitle="Bring your payroll and employee enrollment together in RapidHire ."
        />
      </div>
      <div className="md:flex md:flex-row-reverse  mx-auto justify-between items-center mt-8 gap-5 md:mt-16  md:0">
        ...
        <div className="w-full  mt-6  md:pl-10 md:mt-0 md:w-1/2">
          ...
          <p className="text-gray-800 text-justify text-lg leading-8">
            RapidHire allows you to track hours worked, record time-off, manage
...
<div className="flex pt-10 gap-10">
      ...
      <div>
        <div className="text-center pt-16">
          <Title mainTitle="Explore Payroll, Time, & Benefits with RapidHire " />
        </div>
      </div>
      ...
      <div className="pt-24  text-center">
        ...
        />
<Link to="/demo-page">
          <button className="bg-[#0C1C4D]-700 text-white font-bold my-12 px-6 py-2 rounded-md hover:bg-orange-500 transition ease-out duration-300">
            Get My Free Demo
          </button>
        </Link>
      </div>
      <div className="md:flex items-center  gap-10">
        ...
        <div className="md:w-1/2 space-y-7">
          <h2 className="text-2xl text-gray-700 font-semibold text-second">
            ...
            numbers...it was a complete and utter headache. RapidHire easily
        ...
        <div className="md:flex gap-36 pt-16">
          <div className="space-y-5">
            ...
            <h2 className="font-semibold text-swift text-2xl">
              Simplified Payroll and Time Tracking with RapidHire
            </h2>
            <p className="font-normal text-second text-xl">
              ...
              how RapidHire makes the dream of all-in-one payroll, time
