  ...
  return (
    <div className="max-w-[1100px] mx-auto mt-20">
      <div className=" flex justify-center items-center ">
        <div className="max-w-[700px] text-justify space-y-5">
          ...
          <p className="text-center text[18px] text-gray-500">
            RapidHire software collects and organizes all the information you
            ...
            preparing compensation, or building culture, RapidHire gives you the
      ...
      <div className="md:flex justify-between items-center gap-4 m-10">
        <img
          src="https://i.ibb.co/r2FGG8p/smb-logo.jpg"
          alt="GratImag"
          width={500}
        />
        <div className="space-y-5">
          ...
          <div>
            ...
            <p className="text-gray-500 text-justify">
              We built RapidHire to be intuitive, clear, and easy to use. People
