        ...
        <div className="md:p-10 md:flex gap-4  ">
          <div className="md:w-2/5 w-full border ">
            <table className="w-full shadow-lg rounded-lg overflow-hidden">
              {/* Head */}
              <thead className="bg-[#0C1C4D]-900 text-white">
                <tr>
            ...
            {selectedCandidate ? (
              <div>
                ...
                <div className="bg-white shadow-lg border mt-5 md:mt-0 rounded-lg overflow-hidden">
                  <div>
                    <div className="px-6 py-[5px] border-t bg-[#0C1C4D]-900 text-white border-gray-200">
                      <div className="flex items-center justify-around space-x-4">
                        <a
                          href={RAPIDHIRE_ENDPOINT + `/${selectedCandidate.resume}`}
                          target="_blank"
                  ...
                  <div className="px-6 py-8">
                    ...
                    <div className="mt-6 text-gray-600 text-lg  text-start ">
                      <span className="mb-5  text-blue-900 font-bold text-sm">
                        Summery:
                      </span>
                  ...
                  <div className="px-6 py-4 border-t border-gray-200 text-start">
                    <h3 className="mb-5  text-blue-900 font-bold text-sm">
                      Experience
                    </h3>
                    <ul className="mt-4">
                  ...
                  <div className="px-6 py-4 border-t border-gray-200 text-start ">
                    <p className="mb-5  text-blue-900 font-bold text-sm">
                      Resume:
                    </p>
