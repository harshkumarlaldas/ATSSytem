...
//                       <img
//                         src={`https://829xb1h8bj.execute-api.us-east-1.amazonaws.com/test/images/${candidate.image}`}
//                         alt=""
...
//                     <button className="bg-[#0C1C4D] px-2 py-2 rounded-xl  text-white btn-sm">
//                       Move to Next Step
//                     </button>
//                   </div>
//                 </div>
              ...
              {activeTab === "tabs1" && (
                <div className="space-y-2  text-start">
                  <div className="flex gap-5 justify-end">
                    ...
                    <HiHand size={25} color="red" />
                    <button className="bg-[#0C1C4D] px-4 py-1 rounded-md">
                      Move to Interview
                    </button>
                  </div>
