          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none ${errors.message ? "border-red-500" : "border"
                  }`}
                rows="7"
                id="message"
              ></textarea>
            ...
            <div className="text-center mt-4">
              <button
                type="submit"
                className=" hover:bg-slate-400 bg-orange-800 w-full text-white font-bold py-2 px-4 rounded"
              >
