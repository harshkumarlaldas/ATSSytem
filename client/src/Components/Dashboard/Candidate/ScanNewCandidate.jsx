  ...
  return (
    <div className="my-2">
      <div className="  border rounded-lg p-6">
        ...
        <Link to='/dashboard/peopleSearch' className="w-full  border-orange-800 border text-swift py-2 rounded flex items-center justify-center">
      ...
      <div className=" border rounded-lg p-6 mt-5">
        ...
        <Link to='/dashboard/jobs' className="w-full  border-orange-800 border text-swift py-2 rounded flex items-center justify-center">
          {" "}
