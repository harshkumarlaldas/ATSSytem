...
const EmployeeResource = () => {
  const resources = [
    {
      id: 1,
      name: "Speedway Motors: Measuring Culture with RapidHire ",
      image:
      ...
      description:
        "Hear from Speedway Motors’ director of people operations Betsy Grindlay, a real-life customer, on how RapidHire has helped her organization improve employee performance and company culture.",
    ...
    },
    {
      ...
      description:
        "Tired of researching and comparing? In this short webinar packed with information and first-hand customer stories, we’ll show you how RapidHire makes the dream of all-in-one payroll, time tracking, and benefits data a reality.",
