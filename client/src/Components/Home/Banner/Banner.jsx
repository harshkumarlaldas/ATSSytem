...
// const Banner = () => {
//   return (
//     <div className="bg-[#0C1C4D] text-white">
...
//             <button className="border-[2px] border-white text-white font-semibold hover:bg-white hover:text-blue-900 py-2 px-4 rounded-lg text-lg flex items-center justify-center transition-transform transform hover:scale-105">
//               Get Free Demo <FaArrowRight className="ml-2" />
//             </button>
//             <button className="border-b-[2px] border-white text-white font-semibold hover:bg-white hover:text-blue-900 py-2 px-4 rounded-lg text-lg flex items-center justify-center transition-transform transform hover:scale-105">
...
const Banner = () => {
  return (
    <section className="bg-[#0C1C4D] text-white py-20">
      <div className="container mx-auto flex flex-col md:flex-row items-center p-10">
        <div className="md:w-1/2 md:text-left md:pr-12">
          ...
          <div className="flex mt-7 gap-11">
            ...
            <div className={isDemo ? "text-gray-400 cursor-not-allowed pointer-events-none" :"lg:md:flex items-center"}>
              {/* <div className="flex items-center">
                <div><BsPlayCircleFill className="text-orange-500"></BsPlayCircleFill></div>
                <div>
                  <a href="https://youtube.com/shorts/fokJetG3Z0c?si=zNo9EKkG7OoqQ99F" className="text-sm ms-2 hover:underline italic">SEE RAPID HIRE IN ACTION</a> <span className="mx-4">or</span>
                </div>
              </div> */}

              <div className="lg:md:my-0 my-2">
                <Link to='/register'>
                  <button className=" border py-2 px-4 rounded-lg hover:text-green-900 hover:bg-white flex items-center ">
                    Get Started<MdKeyboardArrowRight className="text-sky-300"></MdKeyboardArrowRight>
                  </button>
                </Link>
              </div>
            </div>
