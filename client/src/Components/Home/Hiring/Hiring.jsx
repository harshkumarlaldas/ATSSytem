      ...
      <div className="container mx-auto md:flex justify-between items-center border-[1px] p-6">
        <div className="md:w-1/2 text-gray-500">
          ...
          <p className="text-lg text-gray-600 leading-7 md:leading-8">
            RapidHire empowers you to quickly discover, recruit, and seamlessly onboard top talent with our Advanced Applicant Tracking System (ATS). Our robust applicant tracking system and proactive onboarding tools enable you to craft an exceptional candidate experience and ensure smooth transitions for new hires.
          </p>
