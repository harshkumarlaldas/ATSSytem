  ...
  return (
    <div className="flex flex-col justify-between items-center gap-4 md:flex-row container mx-auto">
      ...
      <div className="w-full md:w-1/2 p-4">
        <h1 className="text-3xl font-semibold mb-4">Welcome to RapidHire ATS</h1>
        <p>
        RapidHire ATS is your all-in-one solution for streamlining your hiring process.
          From parsing resumes to scheduling interviews and generating reports, we've got you covered.
          Enhance your hiring experience with RapidHire ATS today!
        </p>
        <div className="mt-8">
          <a
