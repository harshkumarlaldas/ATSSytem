...
const UpdateForm = ({ jobTitle, jobPosterEmail, jobId }) => {
  ...
  //   try {
  //     const response = await axios.post(
  //       "https://829xb1h8bj.execute-api.us-east-1.amazonaws.com/test/upload-new",
  //       formData,
  //       {
  //         headers: {
  //           "Content-Type": "multipart/form-data",
  ...
  useEffect(() => {
    axios
      .get(RAPIDHIRE_ENDPOINT + `/all-applications`)
      .then((res) => {
        ...
        <div className="mx-w-5xl container mx-auto pt-5">
          <div className="flex justify-center items-center">
            ...
            >
              ...
              <button
                type="submit"
                className={`bg-[#0C1C4D]-700 px-8 py-1 rounded-md font-semibold text-white w-full mt-6 mb-0 ${
